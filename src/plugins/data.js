...
export const dataItems = [
  { key: '01', icon: '🐔', title: '白肉雞（2.0kg以上）', link: '/01' },
  { key: '02', icon: '🐔', title: '白肉雞（1.75~1.95kg）', link: '/02' },
  { key: '03', icon: '🐔', title: '白肉雞（門市價，高屏）', link: '/03' },
  { key: '04', icon: '🥚', title: '雞蛋（產地）', link: '/04' },
  { key: '05', icon: '🦢', title: '肉鵝（白羅曼）', link: '/05' },
  { key: '06', icon: '🦆', title: '正番鴨（公）', link: '/06' },
  { key: '07', icon: '🦆', title: '土番鴨（75天）', link: '/07' },
  { key: '08', icon: '🥚', title: '鴨蛋（新蛋，台南）', link: '/08' },
  { key: '09', icon: '🐓', title: '紅羽土雞（北區）', link: '/09' },
  { key: '10', icon: '🐓', title: '紅羽土雞（中區）', link: '/10' },
  { key: '11', icon: '🐓', title: '紅羽土雞（南區）', link: '/11' },
  { key: '12', icon: '🐓', title: '黑羽土雞（南區，公，舍飼）', link: '/12' },
  { key: '13', icon: '🐓', title: '黑羽土雞（南區，母，舍飼）', link: '/13' },
];
